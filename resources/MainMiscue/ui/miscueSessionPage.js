...
(function() 
{
    ...
    r_miscue.tt.ui.createSessionWindow = function(usrname,sessionGuid,userId,token,bookGuid,isSessionBookPage,menuItemKey, button_Id) { //V1.8 BEN UPDATE - Added button_Id as a parameter so that it can be used to create a new instance of 'sessionBookPage'.
